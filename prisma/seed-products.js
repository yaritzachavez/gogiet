...
const PRODUCT_CATALOGS = {
  ...
  supermercado: [
    ...
    { name: "Naranja valencia por kg", categoryName: "frutas", price: 36, stock: 24, description: "Naranja jugosa ideal para desayuno y jugos naturales." },
    { name: "Limon con semilla por kg", categoryName: "frutas", price: 32, stock: 26, description: "Limon fresco para salsas, aguas y cocina diaria." },
    { name: "Fresa charola 454 g", categoryName: "frutas", price: 58, stock: 18, badge: "Nuevo", description: "Fresas frescas listas para postres, licuados y antojos." },
    { name: "Aguacate hass por kg", categoryName: "frutas", price: 84, stock: 19, badge: "Mas vendido", description: "Aguacate cremoso para tostadas, ensaladas y guacamole." },
    ...
    { name: "Papa blanca por kg", categoryName: "verduras", price: 31, stock: 28, description: "Papa versatil para pure, guisos, horno y freidora." },
    { name: "Zanahoria por kg", categoryName: "verduras", price: 27, stock: 25, description: "Zanahoria crujiente para sopas, ensaladas y snacks." },
    { name: "Pepino verde por kg", categoryName: "verduras", price: 26, stock: 20, description: "Pepino fresco y ligero para ensaladas y colaciones." },
    { name: "Lechuga romana pieza", categoryName: "verduras", price: 24, stock: 17, description: "Lechuga fresca para ensaladas y wraps del dia." },
