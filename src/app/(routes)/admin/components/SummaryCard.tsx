...
export default function SummaryCard({
  ...
  return (
    <div
      className={`${bgClass} rounded-xl border border-red-100/60 p-4 dark:border-white/10 sm:p-5`}
    >
      <p className="text-xs font-semibold uppercase tracking-wider text-zinc-600 dark:text-zinc-400 sm:text-sm">
        {label}
      </p>
      <p
        className={`${accentClass} mt-2 text-2xl font-bold sm:mt-3 sm:text-3xl`}
      >
        {value}
      </p>
    </div>
