  ...
  try {
    ...
    if (!loggedAuthSchemaCheck) {
      logger.warn(
        ...
        {
          ...schemaState,
          hasResetTable: Boolean(schemaState.hasResetTable),
          hasRateLimitsTable: Boolean(schemaState.hasRateLimitsTable),
          hasAuditLogsTable: Boolean(schemaState.hasAuditLogsTable),
        },
      );
    ...
    const missingTables = [
      !schemaState.hasResetTable ? "password_reset_tokens" : null,
      !schemaState.hasRateLimitsTable ? "auth_rate_limits" : null,
      !schemaState.hasAuditLogsTable ? "auth_audit_logs" : null,
